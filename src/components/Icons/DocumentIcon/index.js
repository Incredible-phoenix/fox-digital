...
const DocumentIcon = ({ className, slideCount, props, viewBox, color, ...rest }) => {
  const classes = useStyles();
  return (
    <SvgIcon width="470.586px" height="470.586px" viewBox="0 0 470.586 470.586" {...rest} className={clsx(classes.root, className)}>
      <g>
